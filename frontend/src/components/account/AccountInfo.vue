<template>
    <b-form @submit="onSubmit" v-if="show">
        <!-- onLoad initalize Fields with Info from server -->
        <template>
    <div>
        ...
        <b-button type="submit" variant="primary">Informationen updaten</b-button>
        <b-button type="delete" variant="danger">Konto Löschen</b-button>
